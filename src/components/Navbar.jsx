  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white">
      ...
      <div onClick={handleNav} className="block md:hidden">
        {!nav ? <AiOutlineClose size={20} className="hover:text-[#00df9a] cursor-pointer" /> : <AiOutlineMenu size={20} className="hover:text-[#00df9a] cursor-pointer" />}
      </div>
      <div
        className={
          !nav
      ...
      >
        ...
        <ul className="uppercase p-4">
          ...
          <li className="p-4 border-b border-gray-600 hover:text-[#00df9a] cursor-pointer">Contact</li>
        </ul>
      </div>
    </div>
  );
